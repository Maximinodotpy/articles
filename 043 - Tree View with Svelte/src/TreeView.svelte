...
<script lang="ts">
    ...
    function summaryKeydown(event) {        
        // Only Prevent if the focus is not on the summary element itself
        ...
        <li>
            {#if item.children}
                <details>
                    ...
                    <summary class="flex" on:keyup={summaryKeydown} role="button" tabindex="0">
